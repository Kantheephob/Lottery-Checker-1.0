        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-700 hover:bg-gray-700 border-b-2 border-gray-500">
              ...
              <TableHead className="text-center text-white font-semibold text-base">หมายเหตุ</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            <TableRow>
              <TableCell colSpan={6} className="h-[400px] text-center text-gray-400 bg-gray-800/50"></TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </div>
